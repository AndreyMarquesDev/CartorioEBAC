...
int registrar() //Função responsavel por cadastrar usuários no sistema.
{
	...
	printf("Digiste o cargo a ser cadastrado: ");
	scanf("%s", cargo);
...
int consultar()
{
    ...
    FILE *file;
	file = fopen(cpf,"r");   //"r" Lê arquivos.
